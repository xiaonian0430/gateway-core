...
class Server implements CommandInterface
{
    ...
    public function help(CommandHelpInterface $commandHelp): CommandHelpInterface
    {
        ...
        $commandHelp->addActionOpt('-mode=produce', 'run mode,produce is default mode');
        return $commandHelp;
    }
    ...
    protected function start()
    {
        ...
        $displayItem['server version'] = SysConst::SERVER_VERSION;
        $displayItem['run mode'] = Core::getInstance()->runMode();
        $displayItem['temp dir'] = SERVER_TEMP_DIR;
        $displayItem['log dir'] = SERVER_LOG_DIR;

        $msg = Color::green(Utility::serverLogo()) . "\n";
